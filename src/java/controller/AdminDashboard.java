...
public class AdminDashboard extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> topProduct = AdminDAO.getTopProductSale();
        float TotalSale = AdminDAO.getSumOrderSale();
        int totalProductSale = AdminDAO.getSumProductSale();
        int TotalUser = AdminDAO.getSumCustomer();
