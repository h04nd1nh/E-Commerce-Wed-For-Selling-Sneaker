                    ...
                    <form action="" method="post">
                        <div>
                            <div class="panel-form">
                                ...
                                <input type="text" name="sizename" id="sizename" placeholder="Type size name here...">
                            </div>
                    ...
                    <form action="" method="post">
                        <div>
                            <div class="panel-form">
                                <p>General Information</p>
                                <label for="sizename">Size Name</label>
                                <input type="text" name="sizename" id="sizename" placeholder="Type size name here..." value="${Size}">
                            </div>
